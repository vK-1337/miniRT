...
NAME			= MiniRT
CC				= cc
FLAGS			= -Wall -Werror -Wextra -g3 -fsanitize=undefined
RM				= rm -f
AR				= ar rcs
NORM			= ./includes\
					./libft/include/\
...
SRC_FUNCTIONS_F	= main atof patterns textures textures2 colors2 color_calculation color_calculation_2 tuple_calculations tuple_calculations2 tuple_calculations_3 rays rays_2 rays_3 \
					matrix_calcul threads matrix_deter_cofac hooks matrix_utils matrix_utils2 utils utils_2 init init2 init3 init4 init5 init6 init7 init8 \
